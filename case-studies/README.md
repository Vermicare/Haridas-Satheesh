...
These case studies are designed to show **how I think**, not only what tools I have used.

Each one uses the same structure:
- problem,
- system design,
...
1. [CORTEX — Governance Intelligence Architecture](cortex-governance-intelligence.md)
2. [Adaptive Non-AC Personal Cooling System](adaptive-personal-cooling.md)
